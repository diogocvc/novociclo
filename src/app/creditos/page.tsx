        ...
        <section className="mt-12">
          ...
          <ul className="space-y-2 text-lg leading-relaxed text-text/80">
            {[
              ...
              { nome: "CNN Brasil", url: "https://www.cnnbrasil.com.br/esportes/" },
              { nome: "CBF", url: "https://www.cbf.com.br/selecao-brasileira" },
              { nome: "FIFA", url: "https://www.fifa.com" },
              { nome: "Lance!", url: "https://www.lance.com.br" },
              { nome: "TNT Sports", url: "https://tntsports.com.br" },
              { nome: "Placar", url: "https://placar.com.br" },
              { nome: "Band Esportes", url: "https://www.band.com.br/esportes" },
